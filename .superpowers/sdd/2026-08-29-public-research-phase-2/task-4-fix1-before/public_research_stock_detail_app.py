...
class StockDetailFixtureStore(InMemoryStore):
    ...
    def _runs(self) -> list[dict]:
        ...
        return [
            {"run_type": "model", "status": "completed", "payload": {"rows": rows, "model_version": "演示模型v1"}},
            {"run_type": "factors", "status": "completed", "payload": {"rankings": rankings, "data_version": "研究快照v1"}},
        ]
...
if "research_navigation_page" not in st.session_state:
    st.session_state["research_navigation_page"] = "个股研究"
